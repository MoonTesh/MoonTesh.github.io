	$(document).ready(function(){
       ...
       $('.thanks__close').on('click', function(event){
           event.preventDefault();
           $('.thanks').fadeOut();
       });

        /* ------ prices ------ */ 
       $('.wiring-btn').on('click', function(event){
          event.preventDefault();
          $('.wiring-prices').fadeIn();
       });
        ...
        $('.floor-btn').on('click', function(event){
         ...
         $('.plumping-btn').on('click', function(event){
          event.preventDefault();
          $('.plumbing-prices').fadeIn();
       });


       $('.prices__close').on('click', function(event){
           event.preventDefault();
           $('.prices').fadeOut();
       });
